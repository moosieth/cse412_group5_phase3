...
INSERT INTO db.Comment (content, dateCreated, userID, photoID) VALUES 
	...
	('righteous', '2023-04-23', 100002, 300032),
	('righteous', '2023-04-23', 100002, 300032),
	('another one', '2023-04-23', 100002, 300031),
	('commenting', '2023-04-23', 100002, 300027),
	('commenting', '2023-04-23', 100002, 300027),
	('comment', '2023-04-23', 100002, 300024),
	('test', '2023-04-23', 100002, 300025),
	('cookie!', '2023-04-23', 100002, 300029),
	('commenting now', '2023-04-23', 100001, 300032),
	('this is cool', '2023-04-23', 100001, 300031),
	('I think so!', '2023-04-23', 100001, 300030),
	('Very funny meme thor!', '2023-04-23', 100001, 300029),
	('that is hilarious nat!', '2023-04-23', 100001, 300028),
	('ok bro', '2023-04-23', 100001, 300027),
	('haha I love The League', '2023-04-23', 100001, 300025),
	('Shrek is so good!', '2023-04-23', 100001, 300024),
	('I want to be an Astronaut', '2023-04-23', 100001, 300023),
	('Looks like fun!', '2023-04-23', 100001, 300022),
	('Fake!', '2023-04-23', 100001, 300021),
	('I can see my house from there!', '2023-04-23', 100001, 300020),
	('sketchy history bro', '2023-04-23', 100001, 300019),
	('UNC!', '2023-04-23', 100001, 300018),
	('Duke sucks!', '2023-04-23', 100001, 300018);